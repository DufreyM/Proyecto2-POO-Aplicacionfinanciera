...
public class Login {
    ...
    public void AgregarRegistro(String nombre, String contraseña, String nombreDelArchivo){
        try {
            ...
            System.out.println("Ha ocurrido un error al escribir el registro: " + e.getMessage());
            e.printStackTrace();
        }
    }
